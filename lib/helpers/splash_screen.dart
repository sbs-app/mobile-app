...
class AnimatedSplashScreen extends StatefulWidget {
  ...
  factory AnimatedSplashScreen(
      ...
      LinearGradient gradient = const LinearGradient(colors: [Colors.white]),
...
class AnimatedSplashScreenState extends State<AnimatedSplashScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(getSplash(), w.gradient);
  }
}

class CustomScaffold extends StatelessWidget {
  const CustomScaffold(this.body, this.gradient, {super.key});
